  ...
  bindProperties() {
      ...
      Object.defineProperty(this, label, {
        ...
        get() {
          return this.profile.mapAxes(
            label,
            gamepads[this.gamepadIndex].axes[index]
          );
        },
      });
    ...
    for (const [label, index] of Object.entries(this.profile.buttons))
      Object.defineProperty(this, label, {
        enumerable: true,
        get() {
          return gamepads[this.gamepadIndex].buttons[index].value;
        },
      });
  }
...
class MouseKeyboardDevice {
  ...
  profile = {
    axes: {
      lHorizontal: () =>
        (this.pressed.ArrowRight || this.pressed.KeyD) -
        (this.pressed.ArrowLeft || this.pressed.KeyA),
      lVertical: () =>
        (this.pressed.ArrowDown || this.pressed.KeyS) -
        (this.pressed.ArrowUp || this.pressed.KeyW),
      rHorizontal: () => 0,
      rVertical: () => 0,
      mouseX: () => this._mouseX,
      mouseY: () => this._mouseY,
